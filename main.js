document.addEventListener("DOMContentLoaded", function () {
    ...
    let partnerName = "Adina"; // Replace with dynamic value
    ...
    yesButton.addEventListener("click", function () {
        questionText.innerHTML = `<span class="partner-name">${partnerName}</span><br><span class="love-text">love u 💖✨</span>`;
    ...
    noButton.addEventListener("click", function () {
        ...
        if (noClickCount < 5) {
            ...
            questionText.innerHTML += `<br><span class="no-choice-text">Haha, you're too cute! There's no escape from my love! 🥰💕</span>`;
        }
    });
